...
function SubjectForm( { setSubjects, subjects } ) {
    ...
    function handleSubmit(e){
        ...
        .then(newSubject => {
            ...
            history.push(`/subject/${newSubject.id}`) 
    ...
    return(   
        ...
        <form onSubmit={handleSubmit} autoComplete="off" className="w-1/4 mx-auto" >
                ...
                <div className="relative z-0 mb-6 w-full group">                
                    <input type="text" id="title" placeholder="Subject Title" name="title" value={formData.title} onChange={handleChange} className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"/>
                </div>
