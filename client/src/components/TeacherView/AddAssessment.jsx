            ...
            <TableBody>
              {assessments.map((row) => (
                ...
                >
                  ...
                  <TableCell align="right"><button onClick={() => navigate(`/edit-assessment/${row.id}`)}><EditIcon /></button></TableCell>
                  <TableCell align="right"><button onClick={() => handleAssessmentDelete(row.id)}><DeleteForeverRoundedIcon /></button></TableCell>
                </TableRow>
              ))}
            </TableBody>
          </Table>
